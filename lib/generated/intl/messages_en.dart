...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m0(name, age) => "Hello ${name}, you are ${age} years old";

  static m1(toy) => "${Intl.select(toy, {'cars': 'I like to play racing cars', 'dolls': 'I like to dress up dolls', 'other': 'I like to play other toys', })}";

  static m2(toys, name, age) => "${Intl.select(toys, {'cars': 'Your name is ${name}, ${age} years old, and you love to play racing cars', 'dolls': 'Your name is ${name}, and you are ${age} years old, and you love to dress up dolls', 'other': 'You are ${name}, ${age} years old', })}";

  static m3(counter) => "${Intl.plural(counter, zero: 'You have not clicked the button yet', one: 'You have clicked the button 1 time', other: 'You have clicked the button ${counter} times')}";
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "summaryAboutYou" : m2,
    "youHavePressThisButtonManyTimes" : m3
  };
}
